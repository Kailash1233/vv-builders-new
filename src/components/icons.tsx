...
export function UsersIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M15.8 12.7c2.4.4 4.2 2.5 4.2 5"
        stroke="currentColor"
        strokeWidth="1.1"
        strokeLinecap="round"
      />
...
export function AwardIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M8.5 13 7 21l5-2.6 5 2.6-1.5-8"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
...
export function CompassIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M15.5 8.5l-2.2 5.3-5.3 2.2 2.2-5.3 5.3-2.2z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
...
export function BuildingIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M7.5 7h1.5M7.5 10.5h1.5M7.5 14h1.5M11 7h1.5M11 10.5h1.5M11 14h1.5M16 12h1M16 15h1"
        stroke="currentColor"
        strokeWidth="1.1"
        strokeLinecap="round"
      />
...
export function LinkedInIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M7.5 10v6.5M7.5 7.6v.01M11.5 16.5V13c0-1.4.9-2.3 2-2.3s1.8.9 1.8 2.3v3.5"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
...
export function DownloadIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        d="M12 4v11.5M7.5 11l4.5 4.5 4.5-4.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function PhoneIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        d="M6 4.5h2.6l1.2 4-2 1.5a10 10 0 0 0 5.2 5.2l1.5-2 4 1.2V17a2.5 2.5 0 0 1-2.7 2.5A15.5 15.5 0 0 1 3.5 7.2 2.5 2.5 0 0 1 6 4.5z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
...
export function PinIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        d="M12 21s6.5-6.1 6.5-11A6.5 6.5 0 1 0 5.5 10c0 4.9 6.5 11 6.5 11z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
